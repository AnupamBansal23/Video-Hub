...
const MyCarousel =()=>(
    <Carousel autoPlay infiniteLoop interval={1000} showStatus={false} showThumbs={false} show showArrows={false}>
        <Box w="full" h={'100vh'}>
            <Image src={img1}/>
        ...
        <Box w="full" h={'100vh'}>
            <Image src={img3}/>
            <Heading bgColor={"whiteAlpha.500"} color={'black'} {...headingOption}>
                Gaming on Console
            </Heading>
